...
version: 1.0.0
description: Scaffold a Python module with implementation, pytest tests, and README in one shot.
trigger: User asks to create a Python script/module, or asks for a Python utility with tests.
---
